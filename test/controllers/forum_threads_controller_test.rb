...
class ForumThreadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create forum_thread" do
    assert_difference("ForumThread.count") do
      post forum_threads_url, params: { forum_thread: { content: @forum_thread.content, title: @forum_thread.title, user_id: @forum_thread.user_id } }, as: :json
    end
  ...
  test "should update forum_thread" do
    patch forum_thread_url(@forum_thread), params: { forum_thread: { content: @forum_thread.content, title: @forum_thread.title, user_id: @forum_thread.user_id } }, as: :json
    assert_response :success
  end
